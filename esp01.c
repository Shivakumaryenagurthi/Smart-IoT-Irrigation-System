...
void esp01_connectAP()
{
	...
	UART0_Str("AT+CWJAP=\"shiva\",\"123456789\"\r\n");
...
//		Write_str_LCD("AT+CIPSEND");
		...
		UART0_Str("GET /update?api_key=MMLFKIA5R2RDFPW5&field1=");
...
//		Write_str_LCD("AT+CIPSEND");
		...
		UART0_Str("GET /update?api_key=MMLFKIA5R2RDFPW5&field1=");		   //"GET /update?api_key=A4IW8PQR3L51TS14&field1="
...
//			Write_CMD_LCD(0x01);
...

		{
			...
			Write_str_LCD("temp IS NOT UPADTED");
...
void esp01_sendToThingspeak3(float val)
{
    ...
    if(strstr(buff, "CONNECT") || strstr(buff, "ALREADY CONNECTED"))
    {
        ...
        UART0_Str("GET /update?api_key=MMLFKIA5R2RDFPW5&field3=");
